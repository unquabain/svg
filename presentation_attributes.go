...
type PresentationAttributes struct {
	...
	Color                      ColorAttr     `xml:"color,attr,omitempty"`
	...
	FloodColor                 ColorAttr     `xml:"flood-color,attr,omitempty"`
	...
	LightingColor              ColorAttr     `xml:"lighting-color,attr,omitempty"`
	...
	SolidColor                 ColorAttr     `xml:"solid-color,attr,omitempty"`
	SolidOpacity               string        `xml:"solid-opacity,attr,omitempty"`
	StopColor                  ColorAttr     `xml:"stop-color,attr,omitempty"`
	...
	Transform                  TransformAttr `xml:"transform,attr,omitempty"`
